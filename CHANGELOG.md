...
- **Chart timeframe selector** — 1M / 3M / 6M / 1Y pill buttons above the chart. Client-side data filtering (no extra API calls). SMA recalculates per timeframe. Active button highlighted in blue.
